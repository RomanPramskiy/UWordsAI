    ...
    return (
        <div className="telegram__block">
            ...
            <div className="telegram__text-block">
                <p className="telegram__text-block-text gray-text-24">подпишитесь на наш Telegram-канал и получите доступ к умному боту🤖!</p>
            </div>
            <div className="telegram__description-block">
                ...
                🎓 <span className="yellow-text yellow-text-telegram">Актуальные учебные материалы и подборки</span> —
                 только полезные слова и выражения.<br></br><br></br>

                 🤝 <span className="yellow-text yellow-text-telegram">Сообщество</span> — общайтесь с
                  единомышленниками и обменивайтесь опытом.<br></br><br></br>

                  🎁<span className="yellow-text yellow-text-telegram">Бонусы и акции</span> — эксклюзивные предложения для
                   подписчиков.
                </p>

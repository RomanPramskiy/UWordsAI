...
export default function students() {
  ...
  <main className="main">
    <div className="container">
      ...
      <div className="students__for-students">


        <section className="students__for-free">
          ...
          <Image src="/images/students__for-free-free.svg" alt="free" width={900} height={500} className="students__for-free-image"/>
        </section>
        ...
        <section className="students__opportunity">
        ...
        <section className="students__instruction">
